...
def add_chamfer(part, size):
    ...
    # Chamfer expects a tuple, not a list
...
# asm.rotate(   instanceList=('side_right',),  axisPoint=(0,0,0),
#               axisDirection=(0,1,0), angle=180.0)
# asm.translate(instanceList=('side_right',),  vector=T_RIGHT)
asm.translate(instanceList=('side_right',), vector=T_RIGHT)
asm.rotate(instanceList=('side_right',), axisPoint=T_RIGHT,
           axisDirection=(0,1,0), angle=180.0)
...
# ---------------------------------------------------------------------------
# 8. Meshing – coarse seeds (2.00 mm)
# ---------------------------------------------------------------------------
