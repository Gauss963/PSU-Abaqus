...
mdb.models['Block-Assembly'].rootAssembly.Surface(name='Surf_shear', 
    ...
    mask=('[#2 ]', ), ))
mdb.models['Block-Assembly'].Pressure('shear_load', 'Shear_Load', 
    mdb.models['Block-Assembly'].rootAssembly.surfaces['Surf_shear'], 
    magnitude=10.0)
...
# Save by gauss112 on 2025_06_20-12.26.32; build 2024.HF2 2024_03_16-03.54.40 RELr426 191119
# Save by gauss112 on 2025_06_20-12.26.33; build 2024.HF2 2024_03_16-03.54.40 RELr426 191119
from part import *
from material import *
from section import *
from assembly import *
...
mdb.models['Block-Assembly'].rootAssembly.Surface(name='Right-Left', 
    ...
    mdb.models['Block-Assembly'].rootAssembly.instances['side_right'].faces.getSequenceFromMask(
    ('[#4 ]', ), ))
# Save by gauss112 on 2025_06_20-12.38.03; build 2024.HF2 2024_03_16-03.54.40 RELr426 191119
