...
mdb.models['Block-Assembly'].parts['center_block'].PartitionCellByPlaneThreePoints(
    ...
    ('[#1 ]', ), ), point1=(10.0, 55.0, 0.0), point2=(0.0, 55.0, 0.0), point3=(
    0.0, 55.0, 10.0))
...
mdb.models['Block-Assembly'].Tie(adjust=ON, main=
    mdb.models['Block-Assembly'].rootAssembly.surfaces['Left-Right'], name=
    'Left-Tie', positionToleranceMethod=COMPUTED, secondary=
    mdb.models['Block-Assembly'].rootAssembly.surfaces['Center-Left'], 
    thickness=ON, tieRotations=ON)
# Save by gauss112 on 2025_06_22-20.34.17; build 2024.HF2 2024_03_16-03.54.40 RELr426 191119
