...
mdb.models['Block-Assembly'].rootAssembly.Surface(name='Center-Right', 
    side1Faces=
    mdb.models['Block-Assembly'].rootAssembly.instances['center_block'].faces.getSequenceFromMask(
    ('[#80 ]', ), ))
mdb.models['Block-Assembly'].rootAssembly.Surface(name='Center-Left', 
    side1Faces=
    mdb.models['Block-Assembly'].rootAssembly.instances['center_block'].faces.getSequenceFromMask(
    ('[#10 ]', ), ))
mdb.models['Block-Assembly'].rootAssembly.Surface(name='Left-Right', 
    side1Faces=
    mdb.models['Block-Assembly'].rootAssembly.instances['side_left'].faces.getSequenceFromMask(
    ('[#4 ]', ), ))
mdb.models['Block-Assembly'].rootAssembly.Surface(name='Right-Left', 
    side1Faces=
...
mdb.models['Block-Assembly'].rootAssembly.Set(faces=
    mdb.models['Block-Assembly'].rootAssembly.instances['side_left'].faces.getSequenceFromMask(
    mask=('[#10 ]', ), ), name='left_bot')
mdb.models['Block-Assembly'].rootAssembly.Set(faces=
    mdb.models['Block-Assembly'].rootAssembly.instances['side_right'].faces.getSequenceFromMask(
    mask=('[#10 ]', ), ), name='right_bot')
...
mdb.models['Block-Assembly'].ConstrainedSketch(gridSpacing=10.66, name=
    '__profile__', sheetSize=426.73, transform=
    mdb.models['Block-Assembly'].parts['center_block'].MakeSketchTransform(
    sketchPlane=mdb.models['Block-Assembly'].parts['center_block'].faces[7], 
    sketchPlaneSide=SIDE1, 
    sketchUpEdge=mdb.models['Block-Assembly'].parts['center_block'].edges[9], 
    sketchOrientation=RIGHT, origin=(50.0, 45.0, 0.0)))
mdb.models['Block-Assembly'].parts['center_block'].projectReferencesOntoSketch(
    filter=COPLANAR_EDGES, sketch=
    mdb.models['Block-Assembly'].sketches['__profile__'])
del mdb.models['Block-Assembly'].sketches['__profile__']
mdb.models['Block-Assembly'].parts['center_block'].PartitionCellByPlanePointNormal(
    cells=
    mdb.models['Block-Assembly'].parts['center_block'].cells.getSequenceFromMask(
    ('[#1 ]', ), ), normal=
    mdb.models['Block-Assembly'].parts['center_block'].edges[9], point=
    mdb.models['Block-Assembly'].parts['center_block'].InterestingPoint(
    mdb.models['Block-Assembly'].parts['center_block'].edges[9], MIDDLE))
# Save by gauss112 on 2025_06_22-20.03.17; build 2024.HF2 2024_03_16-03.54.40 RELr426 191119
