...
mdb.models['Block-Assembly'].Tie(adjust=ON, main=
    mdb.models['Block-Assembly'].rootAssembly.surfaces['Center-Right-Tie'], 
...
mdb.models['Block-Assembly'].interactionProperties['FrictionArea'].NormalBehavior(
    allowSeparation=ON, constraintEnforcementMethod=DEFAULT, 
    pressureOverclosure=HARD)
mdb.models['Block-Assembly'].SurfaceToSurfaceContactStd(adjustMethod=NONE, 
    clearanceRegion=None, createStepName='Initial', datumAxis=None, 
    initialClearance=OMIT, interactionProperty='FrictionArea', main=
    mdb.models['Block-Assembly'].rootAssembly.surfaces['Center-Left-friction'], 
    name='FrictionInteraction_Left', secondary=
    mdb.models['Block-Assembly'].rootAssembly.surfaces['Left-Right-friction'], 
    sliding=FINITE)
mdb.models['Block-Assembly'].SurfaceToSurfaceContactStd(adjustMethod=NONE, 
    clearanceRegion=None, createStepName='Initial', datumAxis=None, 
    initialClearance=OMIT, interactionProperty='FrictionArea', main=
    mdb.models['Block-Assembly'].rootAssembly.surfaces['Center-Right-friction']
    , name='FrictionInteraction_Right', secondary=
    mdb.models['Block-Assembly'].rootAssembly.surfaces['Right-Left-friction'], 
    sliding=FINITE)
...
mdb.models['Block-Assembly'].rootAssembly.Set(edges=
    mdb.models['Block-Assembly'].rootAssembly.instances['side_right'].edges.getSequenceFromMask(
...
mdb.models['Block-Assembly'].DisplacementBC(amplitude=UNSET, createStepName=
    'Shear_Load', distributionType=UNIFORM, fieldName='', fixed=OFF, localCsys=
    None, name='shear_disp', region=
    mdb.models['Block-Assembly'].rootAssembly.sets['Set_shear'], u1=UNSET, u2=
    -0.875, u3=UNSET, ur1=UNSET, ur2=UNSET, ur3=UNSET)
mdb.models['Block-Assembly'].rootAssembly.setElementType(elemTypes=(ElemType(
    elemCode=C3D8I, elemLibrary=STANDARD), ), regions=(
    mdb.models['Block-Assembly'].rootAssembly.instances['side_left'].cells, ))
...
mdb.models['Block-Assembly'].rootAssembly.setElementType(elemTypes=(ElemType(
    elemCode=C3D8I, elemLibrary=STANDARD), ), regions=(
    mdb.models['Block-Assembly'].rootAssembly.instances['side_right'].cells, ))
mdb.models['Block-Assembly'].rootAssembly.seedPartInstance(regions=(
...
mdb.models['Block-Assembly'].rootAssembly.setElementType(elemTypes=(ElemType(
    elemCode=C3D8I, elemLibrary=STANDARD), ), regions=(
    mdb.models['Block-Assembly'].rootAssembly.instances['spring'].cells, ))
mdb.models['Block-Assembly'].rootAssembly.seedPartInstance(regions=(
...
mdb.models['Block-Assembly'].rootAssembly.setElementType(elemTypes=(ElemType(
    elemCode=C3D8I, elemLibrary=STANDARD), ), regions=(
    mdb.models['Block-Assembly'].rootAssembly.instances['steel_plate'].cells, 
    ))
mdb.models['Block-Assembly'].rootAssembly.seedPartInstance(regions=(
...
mdb.models['Block-Assembly'].rootAssembly.setElementType(elemTypes=(ElemType(
    elemCode=C3D8I, elemLibrary=STANDARD), ), regions=(
    mdb.models['Block-Assembly'].rootAssembly.instances['center_block'].cells, 
    ))
mdb.models['Block-Assembly'].rootAssembly.seedPartInstance(regions=(
...
mdb.models['Block-Assembly'].FieldOutputRequest(createStepName='Shear_Load', 
...
mdb.models['Block-Assembly'].FieldOutputRequest(createStepName='Shear_Load', 
    ...
    mdb.models['Block-Assembly'].rootAssembly.allInstances['side_left'].sets['all']
    , sectionPoints=DEFAULT, variables=('ENER', 'ELEN', 'ELEDEN'))
mdb.models['Block-Assembly'].FieldOutputRequest(createStepName='Shear_Load', 
    frequency=1, name='Side-Block-Right-Strain-Energy', rebar=EXCLUDE, region=
    mdb.models['Block-Assembly'].rootAssembly.allInstances['side_right'].sets['all']
    , sectionPoints=DEFAULT, variables=('ENER', 'ELEN', 'ELEDEN'))
mdb.models['Block-Assembly'].FieldOutputRequest(createStepName='Shear_Load', 
    frequency=1, name='Steel-Plate-Energy', rebar=EXCLUDE, region=
    mdb.models['Block-Assembly'].rootAssembly.allInstances['steel_plate'].sets['plate_set']
    , sectionPoints=DEFAULT, variables=('ENER', 'ELEN', 'ELEDEN'))
mdb.Job(model='Block-Assembly', name='BlockJob-75')
mdb.models['Block-Assembly'].FieldOutputRequest(createStepName='Shear_Load', 
    name='Side-Block-Left-Stress', rebar=EXCLUDE, region=
    mdb.models['Block-Assembly'].rootAssembly.allInstances['side_left'].sets['all']
    , sectionPoints=DEFAULT, variables=('S', 'MISES', 'MISESMAX', 'TSHR', 
...
# Save by gauss112 on 2025_07_24-09.46.00; build 2024.HF2 2024_03_16-03.54.40 RELr426 191119
