...
mdb.models['Block-Assembly'].StaticStep(name='Shear_Load', previous=
    'Normal_Load')
mdb.models['Block-Assembly'].HistoryOutputRequest(createStepName='Normal_Load', 
    name='H-Output-SystemU-Normal', variables=('ALLSE', ))
mdb.models['Block-Assembly'].HistoryOutputRequest(createStepName='Shear_Load', 
    name='H-Output-SystemU-Shear', variables=('ALLSE', ))
...
# Save by gauss112 on 2025_07_17-10.15.00; build 2024.HF2 2024_03_16-03.54.40 RELr426 191119
