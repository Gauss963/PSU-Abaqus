...
mdb.models['Block-Assembly'].parts['center_block'].PartitionCellByPlaneThreePoints(
    ...
    mdb.models['Block-Assembly'].parts['center_block'].edges[3], MIDDLE), 
    point2=mdb.models['Block-Assembly'].parts['center_block'].InterestingPoint(
    mdb.models['Block-Assembly'].parts['center_block'].edges[11], MIDDLE), 
    point3=mdb.models['Block-Assembly'].parts['center_block'].InterestingPoint(
    mdb.models['Block-Assembly'].parts['center_block'].edges[15], MIDDLE))
# Save by gauss112 on 2025_06_22-20.06.09; build 2024.HF2 2024_03_16-03.54.40 RELr426 191119
# Save by gauss112 on 2025_06_22-20.06.11; build 2024.HF2 2024_03_16-03.54.40 RELr426 191119
