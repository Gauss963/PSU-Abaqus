...
mdb.models['Block-Assembly'].ContactProperty('IntProp-1')
mdb.models['Block-Assembly'].interactionProperties['IntProp-1'].TangentialBehavior(
    dependencies=0, directionality=ISOTROPIC, elasticSlipStiffness=None, 
    formulation=PENALTY, fraction=0.005, maximumElasticSlip=FRACTION, 
    pressureDependency=OFF, shearStressLimit=None, slipRateDependency=OFF, 
    table=((0.35, ), ), temperatureDependency=OFF)
mdb.models['Block-Assembly'].interactionProperties.changeKey(fromName=
    'IntProp-1', toName='FrictionArea')
# Save by gauss112 on 2025_06_23-00.08.11; build 2024.HF2 2024_03_16-03.54.40 RELr426 191119
